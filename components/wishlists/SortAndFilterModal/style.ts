...
export const styles = StyleSheet.create({
  ...
  sortSheetContent: { paddingBottom: 32, paddingHorizontal: 32, paddingTop: 0, gap: 24 },
  sortSheetTitle: { fontSize: 24, fontFamily: "Nunito_700Bold", color: "#1C0335", textAlign: "center", marginTop: 8 },
